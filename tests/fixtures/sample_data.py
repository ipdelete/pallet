...
SAMPLE_JSONRPC_REQUEST = {
    "jsonrpc": "2.0",
    "method": "create_plan",
    "params": {"requirements": "Create a function to validate email addresses"},
    "id": "test-1",
}

SAMPLE_JSONRPC_RESPONSE = {
    "jsonrpc": "2.0",
    "result": {"title": "Email Validator", "steps": []},
    "id": "test-1",
}

SAMPLE_JSONRPC_ERROR = {
    "jsonrpc": "2.0",
    "error": {"code": -1, "message": "Unknown skill"},
    "id": "test-1",
}
...
REQUIREMENTS_TODO_LIST = (
    "Build a TODO list manager with add, remove, and list functionality"
)
...
REVIEW_POOR = {
    "quality_score": 4,
    "issues": [
        {"type": "bug", "line": 10, "comment": "Potential null pointer exception"},
        {"type": "security", "line": 15, "comment": "SQL injection vulnerability"},
    ],
    "suggestions": [
...
# Registry Data
REGISTRY_CATALOG = {"repositories": ["agents/plan", "agents/build", "agents/test"]}

REGISTRY_TAGS = {"name": "agents/plan", "tags": ["v1", "latest"]}
